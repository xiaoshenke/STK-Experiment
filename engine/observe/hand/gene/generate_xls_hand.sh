...
type=$(python engine/observe/hand/gene/gene_cli.py may_change_xls_template_type $type)

cur_dir=/Users/wuxian/Desktop/STK-Experiment

to_file="/Users/wuxian/Desktop/stk_daily/$day/juben/$to_name.tmp.properties"
