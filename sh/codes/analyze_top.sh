...
if [ $# -lt 1 ]
then
	echo Usage: sh/codes/analyze_top.sh code-type 
      	exit 2
fi
...
echo sh/template/run_xls_template.sh $code_type analyze_top --day $day --time_str $time_str --mode $mode 
sh/template/run_xls_template.sh $code_type analyze_top --day $day --time_str $time_str --mode $mode 
