...
echo sh/template/run_pool_template.sh $pool_type pool_analyze_upstp --day $day --mode $mode
sh/template/run_pool_template.sh $pool_type pool_analyze_upstp --day $day --mode $mode
