...
ignore_list = [ "common.txt","threadpool.py","README.md","no_builder.py","wrap_alias_builder.py","single_builder.py","tuxing_builder.py","crypt_all.py","crypt_cli.py","time_util.py","secret","stk_lock.py","crypt_util.py","crypt_test","hack_urlopen.py","cons.py","sh_util.py","log.py","load_memory.py","print_exe_time.py","updater.py","__init__.py","dir_util.py","crontab.py",".DS_Store","realtime.properties",".gitignore" ]
