...
def get_pan_dir(day=''):
	return '%s/pan/'%(get_daily_dir(day))

def get_chain_dir(day=''):
	return '%s/chain/'%(get_daily_dir(day))

def get_caozuo_dir(day=''):
	return '%s/caozuo/'%(get_daily_dir(day))

def get_hand_dir(day=''):
	return '%s/hand/'%(get_daily_dir(day))

def get_xiwei_dir(day=''):
	return '%s/xiwei/'%(get_daily_dir(day))

def get_tips_dir(day=''):
	return '%s/tips/'%(get_daily_dir(day))

# 用于存储index的df文件
def get_index_dir(day=''):
	return '%s/index/'%(get_daily_dir(day))
...
def get_flush_dir(day=''):
	return '%s/flush/'%get_daily_dir(day)
...
def get_juben_dir(day=''):
	return '%s/juben/'%get_daily_dir(day)
...
def get_opener_dir(day=''):
	return "%s/opener/"%get_daily_dir(day)
...
# 用于保存if condition的计算cache
def get_if_cache_dir(day=''):
	return "%s/if_cache/"%get_daily_dir(day)
